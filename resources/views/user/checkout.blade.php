...
@section('content')
	<div class="bg-gray-50 font-sans" x-data="{
		...
		<form method="POST" action="{{ route('booking.store', $jadwal->id) }}">
			...
			@if (session('success'))
				<div class="mb-4 rounded-2xl border border-green-200 bg-green-50 p-4 text-sm text-green-700">
					{{ session('success') }}
				</div>
			@endif
				...
				<div class="flex-1 space-y-6">
					<div
						...
						<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
							<div>
								<label
									class="mb-2 block text-[10px] font-black uppercase tracking-widest text-gray-400">Nama
									Lengkap</label>
								<input
							...
							<div>
								<label
									class="mb-2 block text-[10px] font-black uppercase tracking-widest text-gray-400">Nomor
									WhatsApp</label>
								<input
									class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm outline-none transition focus:ring-2 focus:ring-blue-500"
							...
							<div class="md:col-span-2">
								<label
									class="mb-2 block text-[10px] font-black uppercase tracking-widest text-gray-400">Email</label>
								<input
									class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm outline-none transition focus:ring-2 focus:ring-blue-500"
					...
					<div
						...
						<div class="mb-6 flex items-center justify-between">
							<div class="flex items-center gap-3">
								<div
									class="flex h-10 w-10 items-center justify-center rounded-full bg-orange-50 text-orange-600">
									<i class="fas fa-user"></i>
								</div>
								<h3 class="text-sm font-black uppercase tracking-wider text-gray-800">Detail Penumpang 1
								</h3>
							</div>
							<label class="flex cursor-pointer items-center gap-2">
								...
								<div class="relative">
									...
									<div class="absolute left-1 top-1 h-4 w-4 transform rounded-full bg-white shadow-2xl ring-1 ring-gray-200 transition-transform duration-200 ease-in-out"
						...
						<div class="space-y-4">
							<div>
								...
								<input
									...
									name="nama_penumpang" type="text" x-model="passengerName" :readonly="sameAsBooker"
									required :class="sameAsBooker ? 'bg-gray-100 text-gray-500' : 'bg-gray-50'">
							</div>
							<div>
								<label
									class="mb-2 block text-[10px] font-black uppercase tracking-widest text-gray-400">NIK</label>
								<div class="relative">
									...
									<input
										...
										name="nik" type="text" x-model="passengerID" required
