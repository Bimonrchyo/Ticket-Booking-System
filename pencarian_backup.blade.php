				...
				<title>Hasil Pencarian Pesawat | PastiTravel</title>
				...
				<div class="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-8 lg:flex-row" x-data="{ showFilter: false }">
				...
				<div
				class="fixed bottom-0 left-0 right-0 z-50 max-h-[90vh] overflow-y-auto rounded-t-[40px] bg-white p-8 lg:hidden"
				...
				href="{{ route('pencarian', array_merge(request()->query(), ['departure_time' => '0-6'])) }}">00:00 -
				06:00</a>
				<a
				...
				href="{{ route('pencarian', array_merge(request()->query(), ['departure_time' => '6-12'])) }}">06:00 -
				12:00</a>
				<a
